...
from poker.WinPatterns import HighCard, Pair, TwoPair, ThreeOfAKind, Straight
...
class Game:
    ...
    def player_one_wins(self):
        if self.player_one_has_a_better_win_pattern():
            ...
            if type(self.hand_1.win_pattern()) in [HighCard, Pair, TwoPair, ThreeOfAKind, Straight]:
